    ...
    <div className="flex flex-col w-full h-screen items-center justify-center bg-gradient-to-br from-indigo-400 via-blue-200 to-pink-200">
      <div className="backdrop-blur-xl bg-white/60 shadow-2xl rounded-2xl p-10 border border-white/40 fade-in">
        <div className="w-[600px] flex gap-10 overflow-hidden">
          <div className={`w-1/2 h-full ${!isSignUp ? 'slide-in-right' : 'opacity-0'}`}>
          ...
          <div className={`w-1/2 h-full ${isSignUp ? 'slide-in-left' : 'opacity-0'}`}>
            <div className="flex flex-col items-center mb-8">
              <h1 className="text-3xl font-bold mb-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                Create Account
              </h1>
              <p className="text-gray-500 text-sm mb-2 text-center max-w-[280px]">
                Join our community and start your journey with us. We&apos;re excited to have you on
                board!
              </p>
            </div>
            <RegisterForm />
          ...
          >
            <div className="h-full flex flex-col items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-600 p-8 rounded-2xl">
